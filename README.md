...
- [nilbuild/brusher](https://github.com/nilbuild/brusher) - Create beautiful webpage backgrounds
...
- [nnx0r/vidage](https://github.com/nnx0r/vidage) - Your solution to full-screen background video & image combined.
...
- [GetStream/stream-chat-ruby](https://github.com/GetStream/stream-chat-ruby) - Official Stream Chat API client for Ruby (maintenance mode). For new projects, see getstream-ruby.
